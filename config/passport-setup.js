...
passport.use(
    new GoogleStrategy({
        ...
        console.log("<<<<<<<<<<<<<<<<<<<<<<passport call back function fired for GOOGLE>>>>>>>>>>>>>>>>>>>>>");
        console.log(profile);
...
passport.use(new Strategy({
    ...
    callbackURL:'https://ec73300f719c.ngrok.io/auth/facebook/redirect',
    Proxy:false,
...
//     callbackURL: "https://f913e9bab886.ngrok.io/instagram/redirect",
//   }, (accessToken, refreshToken, profile, done) => {
